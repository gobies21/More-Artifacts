...
public class TrueEnderianScarfModel<T extends Entity> extends EntityModel<T> {
    public final ModelPart true_enderian_scarf;
    public final ModelPart scarf_base;

    public TrueEnderianScarfModel(ModelPart root) {
        this.true_enderian_scarf = root.getChild("true_enderian_scarf");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition enderian_scarf = partdefinition.addOrReplaceChild("true_enderian_scarf", CubeListBuilder.create().texOffs(3, 32).addBox(-4.5F, -24.0F, -3.0F, 9.0F, 2.0F, 6.0F, new CubeDeformation(0.2F))
