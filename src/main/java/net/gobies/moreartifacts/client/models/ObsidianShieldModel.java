...
public class ObsidianShieldModel<T extends Entity> extends EntityModel<T> {
    ...
    public ObsidianShieldModel(ModelPart root) {
        this.ObsidianShield = root.getChild("Obsidian_Shield");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Obsidian_Shield = partdefinition.addOrReplaceChild("Obsidian_Shield", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -23.5F, 2.0F, 6.0F, 11.0F, 0.5F, new CubeDeformation(0.0F))
    ...
    public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ObsidianShield.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }
}