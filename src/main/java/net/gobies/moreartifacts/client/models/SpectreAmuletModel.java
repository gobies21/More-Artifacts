...
public class SpectreAmuletModel<T extends Entity> extends EntityModel<T> {
    private final ModelPart spectre_amulet;

    public SpectreAmuletModel(ModelPart root) {
        this.spectre_amulet = root.getChild("spectre_amulet");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition spectre_amulet = partdefinition.addOrReplaceChild("spectre_amulet", CubeListBuilder.create().texOffs(6, 0).addBox(-2.5F, -24.0F, 0.0F, 0.5F, 0.0F, 1.0F, new CubeDeformation(0.01F))
    ...
    public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        spectre_amulet.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }
}