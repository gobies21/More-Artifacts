...
import net.gobies.moreartifacts.client.models.VenomAmuletModel;
...
public class VenomAmuletRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/venom_amulet.png");
    private final VenomAmuletModel<LivingEntity> model;

    public VenomAmuletRenderer() {
        this.model = new VenomAmuletModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.VENOM_AMULET));
    }
