...
import net.gobies.moreartifacts.client.models.CobaltShieldModel;
...
public class CobaltShieldRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/cobalt_shield.png");
    private final CobaltShieldModel<LivingEntity> model;

    public CobaltShieldRenderer() {
        this.model = new CobaltShieldModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.COBALT_SHIELD));
    }
