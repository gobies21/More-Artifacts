...
import net.gobies.moreartifacts.client.models.MechanicalGloveModel;
...
public class MechanicalGloveRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/mechanical_glove.png");
    private final MechanicalGloveModel<LivingEntity> model;

    public MechanicalGloveRenderer() {
