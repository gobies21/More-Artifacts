...
import net.gobies.moreartifacts.client.models.DecayAmuletModel;
...
public class DecayAmuletRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/decay_amulet.png");
    private final DecayAmuletModel<LivingEntity> model;

    public DecayAmuletRenderer() {
        this.model = new DecayAmuletModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.DECAY_AMULET));
    }
