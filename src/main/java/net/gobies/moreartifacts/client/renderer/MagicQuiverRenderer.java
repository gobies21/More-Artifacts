...
import net.gobies.moreartifacts.client.models.MagicQuiverModel;
...
public class MagicQuiverRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/magic_quiver.png");
    private final MagicQuiverModel<LivingEntity> model;

    public MagicQuiverRenderer() {
        this.model = new MagicQuiverModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.MAGIC_QUIVER));
    }
