...
import net.gobies.moreartifacts.client.models.MelodyPlushieModel;
...
public class MelodyPlushieRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/my_melody.png");
    private final MelodyPlushieModel<LivingEntity> model;

    public MelodyPlushieRenderer() {
        this.model = new MelodyPlushieModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.MELODY_PLUSHIE));
    }
