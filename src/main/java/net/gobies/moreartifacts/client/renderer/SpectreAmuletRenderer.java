...
import net.gobies.moreartifacts.client.models.SpectreAmuletModel;
...
public class SpectreAmuletRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/spectre_amulet.png");
    private final SpectreAmuletModel<LivingEntity> model;

    public SpectreAmuletRenderer() {
        this.model = new SpectreAmuletModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.SPECTRE_AMULET));
    }
