...
import net.gobies.moreartifacts.client.models.AnkhShieldModel;
...
public class AnkhShieldRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/ankh_shield.png");
    private final AnkhShieldModel<LivingEntity> model;

    public AnkhShieldRenderer() {
        this.model = new AnkhShieldModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.ANKH_SHIELD));
    }
