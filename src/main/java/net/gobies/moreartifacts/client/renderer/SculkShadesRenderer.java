...
import net.gobies.moreartifacts.client.models.SculkShadesModel;
...
public class SculkShadesRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/sculk_shades.png");
    private final SculkShadesModel<LivingEntity> model;

    public SculkShadesRenderer() {
        this.model = new SculkShadesModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.SCULK_SHADES));
    }
