...
import net.gobies.moreartifacts.client.models.SculkLensModel;
...
public class SculkLensRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation("moreartifacts", "textures/models/sculk_lens.png");
    private final SculkLensModel<LivingEntity> model;

    public SculkLensRenderer() {
        this.model = new SculkLensModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(MAModelLayer.SCULK_LENS));
    }
